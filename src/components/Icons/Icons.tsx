...
export const IconLogo = ({ height = 120, width = 350 }: dimensions) => (
    <svg
        id='Layer_1'
...
export const IconPokeBall = () => (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512.45 512.52'>
        <defs>
            <style>
                {`.cls-1{fill:#010101;}.cls-2{fill:#ec2324;}.cls-3{fill:#e6e6e6;}.cls-4{fill:#e5e6e5;}.cls-5{fill:#070606;}`}
            </style>
        </defs>
        <title>Asset 9@</title>
        <g id='Layer_2' data-name='Layer 2'>
            <g id='Layer_1-2' data-name='Layer 1'>
                <path
                    className='cls-1'
                    d='M512.45,256.13A255.73,255.73,0,0,1,256.77,512.52C115.21,512.77.18,398.33,0,257-.18,115.08,114.57,0,256.36,0,397.79,0,512.28,114.49,512.45,256.13Z'
                />
                <path
                    className='cls-2'
                    d='M336.9,323.94c-4.69,1.29-7.73-1.75-10.88-5.69-11.54-14.44-24.95-26.77-41.54-35.34C257.79,269.12,232,270.7,207,287.24c-12.65,8.37-23.15,19.06-32.27,31-3.48,4.56-7.17,6-12.63,5.83-17.45-.66-34.29-4.33-50.77-9.83-31.62-10.54-60.81-25.77-85.64-48.08C2.05,244.94,5.42,245.91,9.79,221.43,16.53,183.69,29.88,148.34,50.67,116c29.39-45.75,69.87-77.32,121.7-93.74s104.14-17.47,156.44-2.4C393,38.33,440,78.32,471.94,136.5a280.52,280.52,0,0,1,30.9,89.2c1.5,8.9-.65,15.24-6.78,21.48C481.91,261.58,465.55,273,448.23,283c-28.33,16.43-57.86,30.12-89.9,37.75C351.54,322.38,344.69,323.83,336.9,323.94Z'
                />
                <path
                    className='cls-3'
                    d='M12.22,300.09c40.2,32,87.34,47.22,136.74,56.36,10.39,1.92,15,5.65,19,15.68,11.75,29.89,33.26,50.58,65.23,57.76,29,6.49,72.52-3.19,92.08-45.5a114.21,114.21,0,0,0,6.88-18.71c2.7-10.1,2.78-10.3,13.64-11.19a249.48,249.48,0,0,0,44.16-7.84c37-9.87,71-26.17,103-47,2.5-1.63,5-3.21,7.57-4.79.21-.12.56,0,1,0a8.69,8.69,0,0,1,.11,2.82c-12.19,39.31-28,76.92-52.44,110.4-36.56,50.07-84.48,83.06-146.21,92.53-80.35,12.34-154-3.39-215.4-59.65-40.31-36.92-63.52-84-75.68-136.84a7,7,0,0,1-.2-2A11.68,11.68,0,0,1,12.22,300.09Z'
                />
                <path
                    className='cls-4'
                    d='M247.49,405.85c-17.7-.78-33.78-6-46.34-19.43C184.7,368.81,184.7,343.68,201,326c23.48-25.47,69.58-25.7,93.33-.47,17.13,18.21,16.95,44-.62,61.84C281.1,400.18,265.28,405.21,247.49,405.85Z'
                />
                <path
                    className='cls-5'
                    d='M244.5,398a49.82,49.82,0,0,1-33.42-13.84c-15-14.34-15-35-.09-49.43,18.86-18.26,53.72-18.64,72.92-.79,16.14,15,16,37-.65,51.51C273.05,394.34,260.87,398.08,244.5,398Z'
                />
                <path
                    className='cls-3'
                    d='M252.78,392.08c-16.77.17-27.6-3.4-36.43-12-12.13-11.75-12.23-28.89-.44-41,16.43-16.9,47.83-16.78,64.16.24,11.35,11.82,11.24,28.56-.25,40.33C272,387.69,260.88,392.05,252.78,392.08Z'
                />
            </g>
        </g>
    </svg>
